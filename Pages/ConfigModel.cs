...
namespace VisionneusePDF
{
    public static class ConfigVisionneuse
    {
        public static DonneesVisionneuse Config()
        {
            ...
            return deserializer.Deserialize<DonneesVisionneuse>(File.ReadAllText($"/Config/VisionneusePDF/config.unit.yml"));
        }
        ...
        public static DonneesVisionneuse Config(EquipeDocument equipeDocument)
        {
            ...
            var cfg = deserializer.Deserialize<DonneesVisionneuse>(File.ReadAllText($"/Config/VisionneusePdf/{equipeDocument.Equipe}/config.unit.yml"));
